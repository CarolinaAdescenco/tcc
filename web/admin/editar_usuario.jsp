...
<div class="content">
    <div class="container-fluid">
        <div class="section">
            ...
            <h2 class="my-4 title"> <i class="icon icon-pencil"></i> Editar usu�rio <%= usuario.getId()%> - <%= usuario.getNome()%></h2>
            ...
            <form action="ControleUsuario?acao=Editar" method="POST">
                ...
                <div class="row mb-3">
                    <h2 class="my-4 title"> <i class="icon icon-compass-05"></i> Endere�o</h2>
                </div>
